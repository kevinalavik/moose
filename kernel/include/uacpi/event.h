...
UACPI_ALWAYS_ERROR_FOR_REDUCED_HARDWARE(
	uacpi_status uacpi_gpe_info(uacpi_namespace_node *gpe_device,
				    uacpi_u16 idx, uacpi_event_info *out_info))
...
UACPI_ALWAYS_ERROR_FOR_REDUCED_HARDWARE(uacpi_status uacpi_uninstall_gpe_handler(
	uacpi_namespace_node *gpe_device, uacpi_u16 idx,
...
UACPI_ALWAYS_ERROR_FOR_REDUCED_HARDWARE(uacpi_status uacpi_install_gpe_block(
	...
	uacpi_u32 irq))
UACPI_ALWAYS_ERROR_FOR_REDUCED_HARDWARE(uacpi_status uacpi_uninstall_gpe_block(
