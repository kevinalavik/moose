...
static ssize_t devfs_chr_read(file_t *file, void *buf, size_t count, loff_t *pos);
static ssize_t devfs_chr_write(file_t *file, const void *buf, size_t count, loff_t *pos);
